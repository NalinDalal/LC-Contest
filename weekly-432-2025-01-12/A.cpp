...
// task is to traverse grid in zigzag pattern while skipping every alternate
// cell so do like skip every alt cell and then while moving to next row if
// i%2=0 then left to right else right to left also if j%2!=0 skip else add to
// result
