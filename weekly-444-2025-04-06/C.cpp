/* Q3. Maximum Product of Subsequences With an Alternating Sum Equal to K
Hard
6 pt.
...
/* This is a tricky optimization problem involving:

Finding subsequences with a specific alternating sum (even - odd indices),

Maximizing their product, but bounded by a limit.

✅ Constraints Recap:
The alternating sum of the subsequence must equal k.

The product of the selected elements must not exceed limit.

Among valid subsequences, return the maximum product.
